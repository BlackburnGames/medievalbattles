...
##################
  ...
  mysql_query("UPDATE user SET land='$land_rc' WHERE userid='$INC_ID'") or die("Error in query! " . mysql_error());
  mysql_query("UPDATE user SET mts='$mtn_rc' WHERE userid='$INC_ID'") or die("Error in query! " . mysql_error());
