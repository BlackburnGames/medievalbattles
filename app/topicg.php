...
$result1 = mysqli_query($db, "SELECT name, topic, message, lastpost FROM guildthreads WHERE topicid='$topicid'") or die("Error!" . mysqli_error($db));
...
if ($result1) { 
	...
	echo "
		<tr>
			<td bgcolor=$color3 align=left width=15%><b class=forum>" . mb_h($r_name) . "</b></td>
			<td bgcolor=$color3 align=left wuidth=85%><b class=forum>" . mb_h($r_topic) . "</b></td>
		</tr>
		<tr>
