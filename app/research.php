...
else	
{
	...
	else	
	{
			...
			$r18 = $res['r18'] + $ur18;
	 		...
	 		mysqli_query($db, "UPDATE military SET sages='$sages' WHERE email='$email' AND pw='$pw'");
	  		mysqli_query($db, "UPDATE research SET r1='$r1' WHERE email='$email' AND pw='$pw'");
	  		mysqli_query($db, "UPDATE research SET r2='$r2' WHERE email='$email' AND pw='$pw'");
      		mysqli_query($db, "UPDATE research SET r3='$r3' WHERE email='$email' AND pw='$pw'");
      		mysqli_query($db, "UPDATE research SET r4='$r4' WHERE email='$email' AND pw='$pw'");
      		mysqli_query($db, "UPDATE research SET r5='$r5' WHERE email='$email' AND pw='$pw'");
			mysqli_query($db, "UPDATE research SET r6='$r6' WHERE email='$email' AND pw='$pw'");
			mysqli_query($db, "UPDATE research SET r7='$r7' WHERE email='$email' AND pw='$pw'");
      		mysqli_query($db, "UPDATE research SET r8='$r8' WHERE email='$email' AND pw='$pw'");
      		mysqli_query($db, "UPDATE research SET r9='$r9' WHERE email='$email' AND pw='$pw'");
			mysqli_query($db, "UPDATE research SET r10='$r10' WHERE email='$email' AND pw='$pw'");
			mysqli_query($db, "UPDATE research SET r11='$r11' WHERE email='$email' AND pw='$pw'");
			mysqli_query($db, "UPDATE research SET r12='$r12' WHERE email='$email' AND pw='$pw'");
			mysqli_query($db, "UPDATE research SET r13='$r13' WHERE email='$email' AND pw='$pw'");
			mysqli_query($db, "UPDATE research SET r14='$r14' WHERE email='$email' AND pw='$pw'");
			mysqli_query($db, "UPDATE research SET r15='$r15' WHERE email='$email' AND pw='$pw'");
			mysqli_query($db, "UPDATE research SET r16='$r16' WHERE email='$email' AND pw='$pw'");
			mysqli_query($db, "UPDATE research SET r17='$r17' WHERE email='$email' AND pw='$pw'");
			mysqli_query($db, "UPDATE research SET r18='$r18' WHERE email='$email' AND pw='$pw'");
