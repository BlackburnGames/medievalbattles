...
<table border='0' width='80%' align='center'>
	...
	<tr>
		...
		<td class='inner'><center><input type='text' name='notice' size='45' maxlength='60' value='" . mb_h($gnotice) . "'></center></td>
	</tr>
	<tr>
		<td class='main2'><b class='reg'>Guild Info</b></td>
		<td class='inner'><center><input type='text' name='info' size='45' maxlength='60' value='" . mb_h($ginfo) . "'></center></td>
	</tr>
	<tr>
		<td class='main2'><b class='reg'>Guild Flag</b></td>
		<td class='inner'><center><input type='text' name='flag' size='45' maxlength='255' value='" . mb_h($gflag) . "'></center></td>
	</tr>
	<tr>
