...
echo "
<form method='post' action='cresearch.php'>
<table border='0' bordercolor='#808080' align='center' width='80%'>
	<tr><td colspan='7' class='main'><b class='top'>Cancel Research</b></td>
	<tr><td colspan='7' class='main2'>You currently have $asages Sages.</td>
	<tr>
		...
		<td class='main2'><b class='reg'>Cancel Sages</b></td>";
