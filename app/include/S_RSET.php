...
<table border="0" bordercolor="#808080" align=center width="85%">
  ...
  <tr>
      <td class=main2 colspan=10>You currently have <?php echo "$recruits"; ?> recruits to train.</td>
  <tr>
  ...
  <tr>
      ...
      <td class=inner align=center><?php echo"$tsages"; ?></td>
      <td class=inner align=center>500</td>
    <td class=inner align=center colspan=2><?php echo"$dbsage"; ?></td>
    <td class=inner align=center><?php echo"$max_sage"; ?></td>
  ...
  <tr>
    ...
    <td class=inner align=center colspan=2><?php echo"$dbthief"; ?></td>
    <td class=inner align=center><?php echo"$max_thief"; ?></td>
  ...
  <tr>
      ...
      <td class=inner align=center><?php echo"$explorec"; ?></td>
    <td class=inner align=center colspan=2><?php echo"$dbexplorer"; ?></td>
    <td class=inner align=center><?php echo"$max_explorer"; ?></td>
...
<table border="0" bordercolor="#808080" align="center" width="85%">
  ...
  <tr>
    ...
    <td class=inner2><?php echo"$twarriors"; ?></td>
      <td class=inner2><?php echo"$warriorc"; ?></td>
      <td class=inner2><?php echo"$dbwar"; ?></td>
    <td class=inner2><?php echo"$dbwar2"; ?></td>
