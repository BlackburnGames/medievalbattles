...
<table border=0 bordercolor="#808080" align=center width="80%">
	<tr>
		<td class=main colspan=5><b class=reg>Equip Weapon/Spell</b></td>
	<tr>
...
if($race != 'Giant')	{
	...
	<tr>
		...
		<td class=inner2>
			...
			if($res['r8pts'] >= 700000)	{	echo"<option value='Cloud Kill'>Cloud Kill</option>";	 }
			if($res['r9pts'] >= 800000)	{	echo"<option value='Lightning Bolt'>Lightning Bolt</option>";	} 
			if($res['r10pts'] >= 900000)	 {	echo"<option value='Meteor Swarm'>Meteor Swarm</option>";	}
		 echo"
			</center>
            </select>";
	}
...
<br>
<center>
<input class=button type="submit" name="update" value="Equip Weapon">
