...
//	invalid number checks
	...
	mysqli_query($db, "INSERT INTO barter (seller, cost, type, amount, barterid, userid, method, page, guild)	VALUES	('$ename', '$cost', '$type', '$amount', '$maxbid', '$userid', '$method', '$page', '$empireguild') ");
