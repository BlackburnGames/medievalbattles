...
if ($result) { 
echo "
	<table border=0 class=f width=95% align=center cellspacing=0 cellpadding=0>
		<tr>
			<td bgcolor=$color1>
...
echo "
					<tr bgcolor=$color2>
						<td valign=top><strong class=black-small><a href=" . mb_attr("topic.php?topicid={$r['topicid']}") . ">" . mb_h($r['topic']) . "</a></strong></td>
